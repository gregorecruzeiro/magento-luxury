...
class AW_Blog_Block_Manage_Blog_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
		...
		$fieldset->addField(
			...
			'select',
			array(
				'label'	=> Mage::helper('blog')->__('Type of Post'),
				'name'	=> 'typepost',
				'values'	=> array(
					array(
						'value'	=> 1,
						'label'	=> Mage::helper('blog')->__('Slideshow'),
					),
					array(
						'value'	=> 2,
						'label'	=> Mage::helper('blog')->__('Static Image'),
					),
					array(
						'value'	=> 3,
					...
					array(
						'value'	=> 4,
						'label'	=> Mage::helper('blog')->__('Music'),
					),
				),
				'after_element_html' => '<span class="hint">'
                     . Mage::helper('blog')->__(
		...
		$path = 'blogpic' .DS.Mage::registry('blog_data')->getFeaturedImage();
        $form->getElement('featured_image')->setValue($path);
