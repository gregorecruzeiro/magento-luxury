...
class Inovarti_Onestepcheckout_AjaxController extends Mage_Checkout_Controller_Action {
    ...
    public function busca_cepAction() {
       ...
       if (isset($json->cep) && $json->cep != NULL){
             $return = "var resultadoCEP = { 'uf' : '".$json->uf."', 'cidade' : '".$json->localidade."', 'bairro' : '".$json->bairro."', 'tipo_logradouro' : '', 'logradouro' : '".$json->logradouro."', 'resultado' : '1', 'resultado_txt' : 'sucesso%20-%20cep%20completo' }";
       }else{
