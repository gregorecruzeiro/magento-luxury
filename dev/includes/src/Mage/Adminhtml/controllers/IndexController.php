...
class Mage_Adminhtml_IndexController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function resetPasswordAction()
    {
        ...
        try {
            ...
            $this->_getSession()->addError(Mage::helper('adminhtml')->__('Seu link para refazer a senha expirou.'));
    ...
    public function resetPasswordPostAction()
    {
        ...
        try {
            ...
            $this->_getSession()->addError(Mage::helper('adminhtml')->__('Sua senha foi atualizada.'));
            $this->_redirect('*/*/');
            return;
        }
