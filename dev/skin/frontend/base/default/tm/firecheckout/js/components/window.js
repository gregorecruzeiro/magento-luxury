...
FC.Window.prototype = {
    ...
    center: function() {
        var viewportSize   = document.viewport.getDimensions(),
            ...
            parent         = this.window.getOffsetParent(),
            parentOffsetLeft = parseInt(parent.getStyle('margin-left')),
            left, top;
        ...
        if ('undefined' === typeof viewportSize.width) { // mobile fix. not sure is this check is good enough.
            ...
            // fix for the body with margin-left and relative position
            if (parent.getStyle('position') === 'relative' && parentOffsetLeft) {
