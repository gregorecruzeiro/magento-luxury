...
function Minicart(options) {
    ...
    this.selectors = {
        ...
        qty:                  'div.header-minicart span.count_new',
        ...
        if (confirm(el.data('confirm'))) {
            ...
            $j.ajax({
                ...
                if (result.success) {
                    ...
                    cart.updateContentOnRemove(result, el.closest('tr'));
					// Do something here
					$j('#lx-popup-message-content').html('Item(s) removidos.');
